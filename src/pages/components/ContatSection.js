                ...
                <Grid container>
                            ...
                            >
                                <Grid container spacing={2}>
                                    <Grid item lg={6} md={6} sm={6} xs={12}>
                                        <input id="outlined-basic"  className='input-text' placeholder='full name *' />
                                    </Grid>
                                    <Grid item lg={6} md={6} sm={6} xs={12}>
                                        <input id="outlined-basic"  className='input-text' placeholder='Email *' type='email' />
                                    </Grid>
                                </Grid>

                                <input id="outlined-basic"  className='input-text' placeholder='Subject *' />
                                <textarea id="outlined-basic"  className='input-text'  rows={4} placeholder='Your Message *' />
                    ...
                    <Grid item lg={5} md={6} sm={12} xs={0}>
                        <Box sx={{ height: "600px", maxWidth: "450px", position: "relative", top: "0px" , }}>
                            <img src={contatg} height="100%" width="100%" className='contat-setion-img' />
                        </Box>
                    </Grid>
                </Grid>
            </Container>
